...
acf_add_local_field_group(array(
    ...
    'fields' => array(
        array(
            ...
            'name' => 'authorfox_acknowledgements_type',
            'type' => 'radio',
            'instructions' => '',
            'required' => 0,
            'conditional_logic' => 0,
        ...
        array(
            ...
            'name' => 'authorfox_acknowledgements_type_pdf',
            'type' => 'file',
            'instructions' => '',
            'required' => 0,
        ...
        array(
            ...
            'name' => 'authorfox_acknowledgements_type_text',
            'type' => 'wysiwyg',
            'instructions' => '',
            'required' => 0,
            'conditional_logic' => array(
        ...
        array(
            ...
            'name' => 'authorfox_acknowledgements_type_link',
            'type' => 'link',
            'instructions' => '',
            'required' => 0,
            'conditional_logic' => array(
