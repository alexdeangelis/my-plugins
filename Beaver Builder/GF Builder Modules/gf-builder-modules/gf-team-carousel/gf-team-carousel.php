...
/**
 * @class GFPostCarouselModule
 */
class GFPostCarouselModule extends FLBuilderModule {
	...
	public function __construct() {
		parent::__construct(array(
			'name'          	=> __( 'GF Team Carousel', 'fl-builder' ),
			'description'   	=> __( 'Display a carousel of Team Members.', 'fl-builder' ),
			'category'        => __( 'Goodman Fox', 'fl-builder' ),
			'editor_export' 	=> false,
			'partial_refresh'	=> true,
            'dir'             => MY_MODULES_DIR . 'gf-team-carousel/',
            'url'             => MY_MODULES_URL . 'gf-team-carousel/',
			'icon'				=> 'slides.svg',
		));
 ...
 */
FLBuilder::register_module('GFPostCarouselModule', array(
	'slider'      => array(
