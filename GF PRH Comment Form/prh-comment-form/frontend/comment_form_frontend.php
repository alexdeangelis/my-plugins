...
class Comment_Form_Frontend extends Comment_Form_Main {
    ...
    public function footer_output() {
        ...
        $options = $this->options();
        echo '<style>#wp-comment-cookies-consent {margin-right:10px;}</style>';
        ...
        echo "<script>jQuery('.comment-form-cookies-consent label').text('Save my details in this browser for the next time I comment.');</script>";
    }
