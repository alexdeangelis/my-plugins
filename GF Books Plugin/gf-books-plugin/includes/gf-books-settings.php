 ...
 */
function gf_book_settings_page() {
    ?>
    ...
    <div class="wrap gf-books-field-reference">
        ...
        <p>By default, the GF Books Plugin has all of its fields turned on.</p>
        ...
        <form method="post" action="options.php">
            <?php
               ...
               do_settings_sections("gf-book-settings");
...
function book_register_settings_page() {
    add_submenu_page(
        ...
        __( 'Book Field Settings', 'gf-books-plugin' ),
        __( 'Book Field Settings', 'gf-books-plugin' ),
        'manage_options',
        'gf-book-settings',
        'gf_book_settings_page'
    );
}
